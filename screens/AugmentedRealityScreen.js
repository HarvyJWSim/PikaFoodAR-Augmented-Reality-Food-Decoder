...
export default class AugmentedRealityScreen extends React.Component {
  ...
  evaluateDiseRisk = (fuzzyMatchedlabel, digitisedTextJson, label) => {
    console.log("########## Testing Condition 8 ##########");
    console.log("Enter evaluateDiseRisk function");
    console.log("Expected Observations :--->");
    console.log("PARAMETER <LABEL NAME AFTER BEING FUZZY MATCHED> AND <LABEL NAME BEFORE BEING FUZZY MATCHED>")
    console.log("Result :--->");
    console.log("PARAMETER " + fuzzyMatchedlabel + " AND " + label);
    console.log("---##########---");
    // label = label.replace(/\(|\)/, "");
    ...
    fetch(serverUrl, {
        ...
        if (responseJson.length > 0 && responseJson[0].hasOwnProperty("INGD_RECOM")) {
            ...
            if (diseRiskEval != null) {
              ...
              console.log("########## Testing Condition 9 ##########");
              console.log("Expected Observations :--->");
              console.log("Diet disease score between 0% & 100% ");
              console.log("Result :--->");
              console.log("Diet disease score = " + dietDiseEvalScore);
              console.log("---##########---");
  ...
  evaluateAddt = (fuzzyMatchedlabel, digitisedTextJson, label) => {
    console.log("########## Testing Condition 6 ##########");
    console.log("Enter evaluateAddt function");
    console.log("Expected Observations :--->");
    console.log("PARAMETER <LABEL NAME AFTER BEING FUZZY MATCHED> AND <LABEL NAME AFTER BEING FUZZY MATCHED>")
    console.log("Result :--->");
    console.log("PARAMETER " + fuzzyMatchedlabel + " AND " + label);
    console.log("---##########---");
    ...
    fetch(serverUrl, {
        ...
        if (responseJson.length > 0) {
          ...
          console.log("########## Testing Condition 7 ##########");

          console.log("Expected Observations :--->");
          console.log("Additive score between 0% & 100% ");
          console.log("Result :--->");
          console.log("Additive score = " + addtEvalScore);
          console.log("---##########---");
  ...
  snap = async () => {
    console.log("Enter snap function");
    this.setState({
      xPoint1 : [],
      xPoint2 : [],
      yPoint1 : [],
    ...
    if (this.camera) {
      ...
      try {
        ...
        console.log("Expected Observations :---> Response JSON Object from Google Vision WITH TEXT AND LOCATION ");
        console.log("Result :---> Response JSON Object ");
        console.log(digitisedTextJson);
        console.log("---##########---");

        // verifyOCRText = (digitisedTextJson) => {
        //   if (digitisedTextJson.responses[0].textAnnotations[0].description.length != 0) {
        //     return true;
        //   }
        //   else
        //     return false;
        ...
        this.setState({
          ...
          console.log("########## Testing Condition 2 ##########");
          console.log("Expected Observations :--->");
          ...
          text = text.replace("&", ",");
          console.log("########## Testing Condition 3 ##########");
          console.log("Expected Observations :--->");
          console.log("Google Vision PROCESSED LABEL WITHOUT CHARACTER \n, & WORDS and");
          console.log("Result :--->");
          console.log("PROCESSED LABEL RESULT = " + text);
          console.log("---##########---");
          ...
          console.log("########## Testing Condition 4 ##########");
          console.log("Expected Observations :---> ");
          console.log("-> TOKENS WITH STOP WORDS REMOVED");
          console.log("-> TOKENS AFTER LOWER CASE");
          console.log("-> TOKENS AFTER TRIMMING");
          console.log("-> TOKENS AFTER STEMMING");
          console.log("Result :--->");
          console.log("PROCESSED TOKENS = " + tokenList);
          console.log("---##########---");
                ...
                if (responseJson.hasOwnProperty("ingdName")) {
                  ...
                  if (fuzzyMatchedIngdName != "Mismatch") {
                    if (fuzzyMatchedTokenNameList[i] != fuzzyMatchedIngdName) {
                      console.log(fuzzyMatchedTokenNameList[i] + " CHANGED TO " + fuzzyMatchedIngdName);
                      fuzzyMatchedTokenNameList[i] = fuzzyMatchedIngdName;
                    }
                    console.log("########## Testing Condition 5 ##########");
                    console.log("Expected Observations :--->");
                    console.log("FUZZY MATCHED TOKEN (NEAREST MATCHED AND VALID NAME FROM DATABASE)");
                    console.log("Result :--->");
                    console.log("FUZZY MATCHE TOKEN = " + fuzzyMatchedIngdName);
                    console.log("---##########---");
                    this.setState(state => ({
